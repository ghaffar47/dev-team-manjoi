    ...
    <?php } ?>
     ...
     <div class="form-group">
       ...
       <input type="hidden" name="no_tiket" id="hiddenField" value="<?php echo $row['no_tiket'];?>">
        ...
        <label name="keterangan" class="form-control" style="color:#00F"><?php echo $row['keterangan'];?></label>
       
        
  <strong>TINDAKAN PERMOHONAN</strong>
  <label name="laporan_pantau" class="form-control" style="color:#00F"><?php echo $row['laporan_pantau'];?></label>
  
  <strong>PEGAWAI PEMANTAUAN PERMOHONAN</strong>
  <label name="pegawai_pantau" class="form-control" style="color:#00F"><?php echo $row['pegawai_pantau'];?></label>
        
        
        <strong>SENARAI AHLI YANG TERLIBAT </strong>
        <label name="kumpulan" class="form-control" style="color:#00F"><?php echo $row['kumpulan'];?></label>
