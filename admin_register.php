            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <?php endif ?>
                 	...
                 	<li>
                        <a  class="active-menu" href="admin_register.php"><i class="fa fa-desktop fa-3x"></i>Daftar Pengguna</a>
                    </li>
                    <li>
                        <a  href="kemaskini_pengguna.php"><i class="fa fa-qrcode fa-3x"></i> Kemaskini_Pengguna</a>
                    </li>
						   <li  >
                        <a   href="login.php"><i class="fa fa-bar-chart-o fa-3x"></i>Daftar Keluar</a>
                    </li>	
                      </ul>
