           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="ppd_senarai_permohonan.php"><i class="fa fa-edit fa-3x"></i>Senarai Permohonan</a></li>
                    <li><a href="ppd_status_tugas.php"><i class="fa fa-desktop fa-3x"></i>Semak Status Tugasan</a></li>
                    <li><a class="active-menu" href="ppd_directori.php"><i class="fa fa-sitemap fa-3x"></i>Directori Pegawai</a></li>
